...
;// ./docs/core/makeup-active-descendant/index.compiled.js
...
const nav1 = mjs_createLinear(widget1El, focusEl1, focusEl1, "li");
mjs_add(focusEl1);
...
const nav2 = mjs_createLinear(widget2El, focusEl2, containerEl2, "li", {
