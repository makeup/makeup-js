...
var _makeupKeyboardTrap = __webpack_require__(490);
var _makeupScreenreaderTrap = __webpack_require__(448);
...
var _makeupFocusables = _interopRequireDefault(__webpack_require__(698));
...
exports.trap = trap;
exports.untrap = untrap;
var util = _interopRequireWildcard(__webpack_require__(354));
...
var _makeupModal = __webpack_require__(553);
...
document.getElementById("button-1").addEventListener("click", () => (0, _makeupModal.modal)(modal1, getOptions()));
document.getElementById("button-2").addEventListener("click", () => (0, _makeupModal.modal)(modal2, getOptions()));
document.getElementById("button-3").addEventListener("click", () => (0, _makeupModal.modal)(modal3, getOptions()));
unmodalButton.addEventListener("click", () => (0, _makeupModal.unmodal)());
