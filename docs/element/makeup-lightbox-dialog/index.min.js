...
;// CONCATENATED MODULE: ./packages/ui/makeup-lightbox-dialog/dist/mjs/index.js
...
__webpack_unused_export__ = attribToBool;
__webpack_unused_export__ = kebabToCamel;
__webpack_unused_export__ = translateAttributes;
var _makeupLightboxDialog = _interopRequireDefault(__webpack_require__(647));
 ...
 * @returns {boolean}
 */
function attribToBool(attributeValue) {
 ...
 */
function translateAttributes(attributes, booleanAttributes) {
  const options = {};
...
customElements.define("makeup-lightbox-dialog", class extends HTMLElement {
  connectedCallback() {
    ...
    if (this.el) {
      this.widget = new _makeupLightboxDialog.default(this.el, options);
    } else {
