...
/* harmony export */ });
/* harmony import */ var makeup_lightbox_dialog__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5494);
...
__webpack_require__.d(__webpack_exports__, {
  "Z": function() { return /* binding */ dist_mjs_src_default; }
});

;// CONCATENATED MODULE: ./packages/makeup-modal/node_modules/makeup-focusables/dist/mjs/index.js
...
;// CONCATENATED MODULE: ./packages/makeup-modal/node_modules/makeup-keyboard-trap/dist/mjs/index.js
...
;// CONCATENATED MODULE: ./packages/makeup-modal/node_modules/makeup-screenreader-trap/dist/mjs/util.js
...
;// CONCATENATED MODULE: ./packages/makeup-modal/node_modules/makeup-screenreader-trap/dist/mjs/index.js
...
const mjs_focusableElSelector = mjs_focusableElList.join();
function mjs_src_default(el, keyboardOnly = false, callback) {
  if (callback) {
    const request = requestAnimationFrame(() => {
      callback(mjs_getFocusables(el, keyboardOnly));
    });
    return () => {
      cancelAnimationFrame(request);
    };
  }
  return mjs_getFocusables(el, keyboardOnly);
}
function mjs_getFocusables(el, keyboardOnly = false) {
  let focusableEls = Array.prototype.slice.call(el.querySelectorAll(mjs_focusableElSelector));
  focusableEls = focusableEls.filter(function(focusableEl) {
    return window.getComputedStyle(focusableEl).display !== "none";
  });
  if (keyboardOnly === true) {
...
/* harmony export */   "default": function() { return /* binding */ src_default; }
/* harmony export */ });
/* harmony import */ var makeup_dialog__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3150);
...
var _makeupLightboxDialog = _interopRequireDefault(__webpack_require__(5494));
