...
/* harmony export */ });
/* harmony import */ var makeup_next_id__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9905);
/* harmony import */ var makeup_exit_emitter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5386);
/* harmony import */ var makeup_focusables__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5247);
...
function manageFocus(focusManagement, contentEl) {
  if (focusManagement === "content") {
    ...
    (0,makeup_focusables__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z)(contentEl)[0].focus();
  } else if (focusManagement === "interactive") {
    (0,makeup_focusables__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z)(contentEl, true)[0].focus();
...
class src_default {
  constructor(el, selectedOptions) {
    ...
    makeup_exit_emitter__WEBPACK_IMPORTED_MODULE_1__/* .addFocusExit */ .c(this.el);
    ...
    if (this.options.ariaControls === true) {
      (0,makeup_next_id__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)(this.el, "expander");
