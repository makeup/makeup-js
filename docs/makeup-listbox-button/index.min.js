...
__webpack_require__.d(__webpack_exports__, {
  "default": function() { return /* binding */ makeup_listbox_button_dist_mjs_src_default; }
});
...
;// CONCATENATED MODULE: ./packages/makeup-active-descendant/node_modules/makeup-key-emitter/dist/mjs/index.js
...
;// CONCATENATED MODULE: ./packages/makeup-active-descendant/node_modules/makeup-next-id/dist/mjs/index.js
...
;// CONCATENATED MODULE: ./packages/makeup-active-descendant/node_modules/makeup-exit-emitter/dist/mjs/index.js
...
;// CONCATENATED MODULE: ./packages/makeup-active-descendant/node_modules/makeup-navigation-emitter/dist/mjs/index.js
...
function onModelMutation() {
  ...
  this.filteredItems.forEach(function(item, index) {
    makeup_next_id_dist_mjs_src_default(item);
    if (index !== modelIndex) {
...
class makeup_listbox_button_dist_mjs_src_default {
  constructor(widgetEl, selectedOptions) {
    ...
    this.listbox = new makeup_listbox_dist_mjs_src_default(this.el.querySelector(this._options.listboxSelector), {
      activeDescendantClassName: "listbox-button__option--active",
      autoSelect: this._options.autoSelect
    });
    this._expander = new makeup_expander_dist_mjs_src_default(this.el, {
...
var _makeupListboxButton = _interopRequireDefault(__webpack_require__(9735));
...
window.onload = function () {
  document.querySelectorAll('.listbox-button').forEach(function (el, i) {
    var widget = new _makeupListboxButton.default(el, {
