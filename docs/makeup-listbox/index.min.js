...
/* harmony export */ });
/* harmony import */ var makeup_active_descendant__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4282);
/* harmony import */ var makeup_prevent_scroll_keys__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8135);
...
class src_default {
  constructor(widgetEl, selectedOptions) {
    ...
    this._activeDescendant = makeup_active_descendant__WEBPACK_IMPORTED_MODULE_0__/* .createLinear */ .f(this._activeDescendantRootEl, this._options.focusableElement || this._listboxEl, this._listboxEl, "[role=option]", {
    ...
    makeup_prevent_scroll_keys__WEBPACK_IMPORTED_MODULE_1__/* .add */ .I(this.el);
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "f": function() { return /* binding */ createLinear; }
/* harmony export */ });
/* harmony import */ var makeup_navigation_emitter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7159);
/* harmony import */ var makeup_next_id__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3246);
...
function onModelMutation() {
  ...
  this.filteredItems.forEach(function(item, index) {
    (0,makeup_next_id__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)(item);
    if (index !== modelIndex) {
...
class LinearActiveDescendant extends ActiveDescendant {
  constructor(el, focusEl, containerEl, itemSelector, selectedOptions) {
    super(el);
    this._options = Object.assign({}, defaultOptions, selectedOptions);
    this._navigationEmitter = makeup_navigation_emitter__WEBPACK_IMPORTED_MODULE_0__/* .createLinear */ .f(el, itemSelector, {
    ...
    (0,makeup_next_id__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)(containerEl);
    if (containerEl !== focusEl) {
      focusEl.setAttribute("aria-owns", containerEl.id);
    }
    this.items.forEach(function(itemEl) {
      (0,makeup_next_id__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)(itemEl);
    });
...
/* harmony export */ });
/* harmony import */ var makeup_next_id__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3246);
...
/* harmony export */   "f": function() { return /* binding */ createLinear; }
/* harmony export */ });
/* harmony import */ var makeup_key_emitter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7735);
/* harmony import */ var makeup_exit_emitter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9922);
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "I": function() { return /* binding */ add; }
/* harmony export */ });
...
var _makeupListbox = _interopRequireDefault(__webpack_require__(3608));
