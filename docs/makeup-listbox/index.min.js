...
function onModelMutation(e) {
  ...
  this.items.forEach(function(item, index) {
    (0,makeup_next_id__WEBPACK_IMPORTED_MODULE_1__["default"])(item);
    if (index !== toIndex) {
...
class LinearActiveDescendant extends ActiveDescendant {
  constructor(el, focusEl, itemContainerEl, itemSelector, selectedOptions) {
    ...
    (0,makeup_next_id__WEBPACK_IMPORTED_MODULE_1__["default"])(this._itemContainerEl);
    ...
    this.items.forEach(function(itemEl) {
      (0,makeup_next_id__WEBPACK_IMPORTED_MODULE_1__["default"])(itemEl);
    });
  }
  get index() {
...
class src_default {
  constructor(widgetEl, selectedOptions) {
    ...
    this._activeDescendant = makeup_active_descendant__WEBPACK_IMPORTED_MODULE_0__.createLinear(
