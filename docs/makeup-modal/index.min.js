...
/* harmony export */   "unmodal": function() { return /* binding */ unmodal; }
/* harmony export */ });
/* harmony import */ var makeup_keyboard_trap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1195);
/* harmony import */ var makeup_screenreader_trap__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6202);
...
function unmodal() {
  if (modalEl) {
    makeup_keyboard_trap__WEBPACK_IMPORTED_MODULE_0__/* .untrap */ .hb(modalEl);
    makeup_screenreader_trap__WEBPACK_IMPORTED_MODULE_1__/* .untrap */ .h(modalEl);
    unwrap();
    unhoist();
...
function modal(el, options) {
  ...
  makeup_screenreader_trap__WEBPACK_IMPORTED_MODULE_1__/* .trap */ .z(modalEl, options);
  if (!_options.useHiddenProperty) {
    makeup_keyboard_trap__WEBPACK_IMPORTED_MODULE_0__/* .trap */ .zZ(modalEl);
  }
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "zZ": function() { return /* binding */ trap; },
/* harmony export */   "hb": function() { return /* binding */ untrap; }
/* harmony export */ });
/* unused harmony export refresh */
/* harmony import */ var makeup_focusables__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3391);
...
function trap(el) {
  ...
  const focusableElements = (0,makeup_focusables__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)(trappedEl, true);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "z": function() { return /* binding */ trap; },
/* harmony export */   "h": function() { return /* binding */ untrap; }
/* harmony export */ });
/* harmony import */ var _util_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4979);
...
function trap(el, selectedOptions) {
  ...
  const ancestors = _util_js__WEBPACK_IMPORTED_MODULE_0__/* .getAncestors */ .dk(trappedEl);
  let siblings = _util_js__WEBPACK_IMPORTED_MODULE_0__/* .getSiblings */ .m7(trappedEl);
  let siblingsOfAncestors = _util_js__WEBPACK_IMPORTED_MODULE_0__/* .getSiblingsOfAncestors */ .YN(trappedEl);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "dk": function() { return /* binding */ getAncestors; },
/* harmony export */   "m7": function() { return /* binding */ getSiblings; },
/* harmony export */   "YN": function() { return /* binding */ getSiblingsOfAncestors; }
/* harmony export */ });
...
var modal = _interopRequireWildcard(__webpack_require__(1257));
...
modal1.addEventListener('makeup-modal', function (e) {
  return console.log(e);
});
modal2.addEventListener('makeup-modal', function (e) {
  return console.log(e);
});
modal3.addEventListener('makeup-modal', function (e) {
  return console.log(e);
});
modal1.addEventListener('makeup-unmodal', function (e) {
  return console.log(e);
});
modal2.addEventListener('makeup-unmodal', function (e) {
  return console.log(e);
});
modal3.addEventListener('makeup-unmodal', function (e) {
  return console.log(e);
});
...
unmodalButton.addEventListener('click', function () {
  modal.unmodal();
});
}();
/******/ })()
