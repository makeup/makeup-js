...
// EXTERNAL MODULE: ./node_modules/@ebay/skin/combobox.js
var combobox = __webpack_require__(2915);
...
;// ./packages/ui/makeup-combobox/dist/mjs/index.js
...
class makeup_combobox_dist_mjs_index_default {
  constructor(widgetEl, selectedOptions) {
    ...
    this._listboxWidget = new makeup_listbox_dist_mjs_index_default(this._listboxEl, {
    ...
    this._expander = new dist_mjs_index_default(this._el, {
...
;// ./docs/ui/makeup-combobox/index.compiled.js
...
window.onload = function () {
  document.querySelectorAll(".combobox").forEach(function (el, i) {
    const widget = new makeup_combobox_dist_mjs_index_default(el, {
