...
// EXTERNAL MODULE: ./node_modules/@ebay/skin/tokens.js
var tokens = __webpack_require__(4658);
// EXTERNAL MODULE: ./node_modules/@ebay/skin/global.js
var global = __webpack_require__(5015);
// EXTERNAL MODULE: ./node_modules/@ebay/skin/utility.js
var utility = __webpack_require__(7098);
// EXTERNAL MODULE: ./node_modules/@ebay/skin/button.js
var skin_button = __webpack_require__(296);
// EXTERNAL MODULE: ./node_modules/@ebay/skin/icon-button.js
var icon_button = __webpack_require__(6138);
// EXTERNAL MODULE: ./node_modules/@ebay/skin/link.js
var skin_link = __webpack_require__(3668);
// EXTERNAL MODULE: ./node_modules/@ebay/skin/textbox.js
var textbox = __webpack_require__(7798);
// EXTERNAL MODULE: ./node_modules/@ebay/skin/alert-dialog.js
var alert_dialog = __webpack_require__(5625);
// EXTERNAL MODULE: ./node_modules/@ebay/skin/confirm-dialog.js
var confirm_dialog = __webpack_require__(6687);
// EXTERNAL MODULE: ./node_modules/@ebay/skin/drawer-dialog.js
var drawer_dialog = __webpack_require__(2810);
// EXTERNAL MODULE: ./node_modules/@ebay/skin/fullscreen-dialog.js
var fullscreen_dialog = __webpack_require__(5522);
// EXTERNAL MODULE: ./node_modules/@ebay/skin/lightbox-dialog.js
var lightbox_dialog = __webpack_require__(7842);
// EXTERNAL MODULE: ./node_modules/@ebay/skin/panel-dialog.js
var panel_dialog = __webpack_require__(261);
// EXTERNAL MODULE: ./node_modules/@ebay/skin/snackbar-dialog.js
var snackbar_dialog = __webpack_require__(6728);
// EXTERNAL MODULE: ./node_modules/@ebay/skin/toast-dialog.js
var toast_dialog = __webpack_require__(6674);
;// ./packages/ui/makeup-dialog-button/dist/mjs/index.js
...
function mjs_index_default(el, keyboardOnly = false, callback) {
  if (callback) {
...
;// ./packages/core/makeup-keyboard-trap/dist/mjs/index.js
...
function trap(el) {
  ...
  const focusableElements = mjs_index_default(trappedEl, true);
...
function refresh() {
  if (topTrap && trappedEl) {
    let focusableElements = mjs_index_default(trappedEl, true);
...
;// ./packages/core/makeup-screenreader-trap/dist/mjs/util.js
...
;// ./packages/core/makeup-screenreader-trap/dist/mjs/index.js
...
function mjs_trap(el, selectedOptions) {
  mjs_untrap();
  const options = { ...mjs_defaultOptions, ...selectedOptions };
  mjs_trappedEl = el;
  ...
  dirtyObjects = [
    showElementPrep(mjs_trappedEl, options.useHiddenProperty),
...
;// ./packages/core/makeup-modal/dist/mjs/index.js
...
function modal(el, options) {
  const _options = { ...dist_mjs_defaultOptions, ...options };
  unmodal();
  modalEl = el;
  if (_options.hoist) {
    hoist();
...
;// ./packages/ui/makeup-dialog/dist/mjs/transition.js
...
;// ./packages/ui/makeup-dialog/dist/mjs/index.js
...
class dist_mjs_index_default {
  ...
  get focusables() {
    return mjs_index_default(this._windowEl);
  }
  get modal() {
...
;// ./packages/ui/makeup-lightbox-dialog/dist/mjs/index.js
...
class makeup_lightbox_dialog_dist_mjs_index_default extends dist_mjs_index_default {
  constructor(el, selectedOptions = {}) {
    super(el, Object.assign({}, defaultLightboxOptions, selectedOptions, { modal: true }));
  }
  _observeEvents() {
    super._observeEvents();
    this._onClickListener = mjs_onClick.bind(this);
    this._el.addEventListener("click", this._onClickListener);
  }
  _unobserveEvents() {
...
;// ./packages/ui/makeup-alert-dialog/dist/mjs/index.js
...
class makeup_alert_dialog_dist_mjs_index_default extends makeup_lightbox_dialog_dist_mjs_index_default {
  constructor(el, selectedOptions = {}) {
...
;// ./packages/ui/makeup-confirm-dialog/dist/mjs/index.js

const makeup_confirm_dialog_dist_mjs_defaultOptions = {
...
class makeup_confirm_dialog_dist_mjs_index_default extends makeup_lightbox_dialog_dist_mjs_index_default {
  constructor(el, selectedOptions = {}) {
    super(el, Object.assign({}, makeup_confirm_dialog_dist_mjs_defaultOptions, selectedOptions));
  }
  _observeEvents() {
    super._observeEvents();
...
;// ./packages/ui/makeup-drawer-dialog/dist/mjs/index.js
...
class makeup_drawer_dialog_dist_mjs_index_default extends makeup_lightbox_dialog_dist_mjs_index_default {
  constructor(el, selectedOptions = {}) {
...
;// ./packages/ui/makeup-fullscreen-dialog/dist/mjs/index.js
...
class makeup_fullscreen_dialog_dist_mjs_index_default extends dist_mjs_index_default {
  constructor(el, selectedOptions = {}) {
...
;// ./packages/ui/makeup-input-dialog/dist/mjs/index.js
...
class makeup_input_dialog_dist_mjs_index_default extends makeup_lightbox_dialog_dist_mjs_index_default {
  constructor(el, selectedOptions = {}) {
...
;// ./packages/ui/makeup-panel-dialog/dist/mjs/index.js
...
class makeup_panel_dialog_dist_mjs_index_default extends makeup_lightbox_dialog_dist_mjs_index_default {
  constructor(el, selectedOptions = {}) {
...
;// ./packages/ui/makeup-snackbar-dialog/dist/mjs/index.js
...
class makeup_snackbar_dialog_dist_mjs_index_default extends dist_mjs_index_default {
  constructor(el, selectedOptions = {}) {
...
;// ./packages/ui/makeup-toast-dialog/dist/mjs/index.js
...
class makeup_toast_dialog_dist_mjs_index_default extends dist_mjs_index_default {
  constructor(el, selectedOptions = {}) {
  ...
  _observeEvents() {
    ...
    this._ctaEl = this._el.querySelector(this._options.ctaButtonSelector);
    if (this._ctaEl) {
      this._onCtaClickListener = mjs_onCtaButtonClick.bind(this);
      this._ctaEl.addEventListener("click", this._onCtaClickListener);
    }
  }
  _unobserveEvents() {
...
function mjs_onCtaButtonClick() {
  this.cta();
}


;// ./docs/ui/makeup-dialog-button/index.compiled.js
// STYLES
...
window.onload = function () {
  document.querySelectorAll(".dialog-button").forEach(function (el, i) {
    ...
    if (dialogClassList.contains("confirm-dialog")) {
      dialogWidget = new makeup_confirm_dialog_dist_mjs_index_default(dialogEl);
    } else if (dialogClassList.contains("alert-dialog")) {
      dialogWidget = new makeup_alert_dialog_dist_mjs_index_default(dialogEl);
    } else if (dialogClassList.contains("lightbox-dialog--input")) {
      dialogWidget = new makeup_input_dialog_dist_mjs_index_default(dialogEl);
    } else if (dialogClassList.contains("fullscreen-dialog")) {
      dialogWidget = new makeup_fullscreen_dialog_dist_mjs_index_default(dialogEl);
    } else if (dialogClassList.contains("snackbar-dialog")) {
      dialogWidget = new makeup_snackbar_dialog_dist_mjs_index_default(dialogEl);
    } else if (dialogClassList.contains("toast-dialog")) {
      dialogWidget = new makeup_toast_dialog_dist_mjs_index_default(dialogEl);
    } else if (dialogClassList.contains("drawer-dialog")) {
      dialogWidget = new makeup_drawer_dialog_dist_mjs_index_default(dialogEl);
    } else if (dialogClassList.contains("panel-dialog")) {
      dialogWidget = new makeup_panel_dialog_dist_mjs_index_default(dialogEl);
    } else if (dialogClassList.contains("lightbox-dialog")) {
      dialogWidget = new makeup_lightbox_dialog_dist_mjs_index_default(dialogEl);
    }
    const buttonWidget = new index_default(el, dialogWidget);
