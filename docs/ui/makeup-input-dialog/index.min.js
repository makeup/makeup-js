...
function modal(el, options) {
  const _options = { ...mjs_defaultOptions, ...options };
  unmodal();
  modalEl = el;
  if (_options.hoist) {
    hoist();
...
class index_default extends makeup_lightbox_dialog_dist_mjs_index_default {
  constructor(el, selectedOptions = {}) {
...
;// ./docs/ui/makeup-input-dialog/index.compiled.js
...
window.onload = function () {
  document.querySelectorAll(".lightbox-dialog--input").forEach(function (el, i) {
    const widget = new index_default(el);
  });
};
})();
