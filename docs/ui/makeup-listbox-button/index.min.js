...
// EXTERNAL MODULE: ./node_modules/@ebay/skin/listbox-button.js
var listbox_button = __webpack_require__(5160);
...
class LinearActiveDescendant extends ActiveDescendant {
  constructor(el, focusEl, itemContainerEl, itemSelector, selectedOptions) {
    ...
    this._itemSelector = itemSelector;
    mjs_index_default(this._itemContainerEl);
...
;// ./packages/ui/makeup-listbox/dist/mjs/index.js
...
class makeup_listbox_dist_mjs_index_default {
...
class makeup_listbox_button_dist_mjs_index_default {
  constructor(widgetEl, selectedOptions) {
    ...
    this.listbox = new makeup_listbox_dist_mjs_index_default(this._listboxEl, {
    ...
    this._expander = new dist_mjs_index_default(this.el, {
...
;// ./docs/ui/makeup-listbox-button/index.compiled.js
...
window.onload = function () {
  document.querySelectorAll(".listbox-button").forEach(function (el, i) {
    ...
    widgets.push(new makeup_listbox_button_dist_mjs_index_default(el, {
