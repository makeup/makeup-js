...
// EXTERNAL MODULE: ./node_modules/@ebay/skin/listbox.js
var listbox = __webpack_require__(7443);
...
class LinearActiveDescendant extends ActiveDescendant {
  constructor(el, focusEl, itemContainerEl, itemSelector, selectedOptions) {
    super(el);
    this._options = { ...mjs_defaultOptions, ...selectedOptions };
    this._focusEl = focusEl;
    this._itemContainerEl = itemContainerEl;
    this._itemSelector = itemSelector;
    index_default(this._itemContainerEl);
...
;// ./docs/ui/makeup-listbox/index.compiled.js
...
window.onload = function () {
  document.querySelectorAll(".listbox").forEach(function (el, i) {
    ...
    widgets.push(new mjs_index_default(el, {
