...
/* harmony export */   q: () => (/* binding */ createLinear)
/* harmony export */ });
/* harmony import */ var makeup_navigation_emitter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7551);
/* harmony import */ var makeup_next_id__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9587);
...
function onModelMutation(e) {
  ...
  this.items.forEach(function(item, index) {
    (0,makeup_next_id__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)(item);
    if (index !== toIndex) {
...
class LinearActiveDescendant extends ActiveDescendant {
  constructor(el, focusEl, itemContainerEl, itemSelector, selectedOptions) {
    ...
    (0,makeup_next_id__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)(this._itemContainerEl);
    if (this._itemContainerEl !== this._focusEl) {
      focusEl.setAttribute("aria-owns", this._itemContainerEl.id);
    }
    this._navigationEmitter = makeup_navigation_emitter__WEBPACK_IMPORTED_MODULE_0__/* .createLinear */ .q(el, itemSelector, {
    ...
    this.items.forEach(function(itemEl) {
      (0,makeup_next_id__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)(itemEl);
    });
  }
  get index() {
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Q: () => (/* binding */ addFocusExit),
/* harmony export */   n: () => (/* binding */ removeFocusExit)
/* harmony export */ });
/* harmony import */ var makeup_next_id__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9587);
...
function addFocusExit(el) {
  ...
  (0,makeup_next_id__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)(el);
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   SM: () => (/* binding */ removeKeyDown),
/* harmony export */   t3: () => (/* binding */ addKeyDown)
/* harmony export */ });
...
/* harmony export */   q: () => (/* binding */ createLinear)
/* harmony export */ });
/* harmony import */ var makeup_key_emitter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7840);
/* harmony import */ var makeup_exit_emitter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8921);
...
class NavigationEmitter {
  ...
  constructor(el, model) {
    ...
    makeup_key_emitter__WEBPACK_IMPORTED_MODULE_1__/* .addKeyDown */ .t3(this.el);
    makeup_exit_emitter__WEBPACK_IMPORTED_MODULE_0__/* .addFocusExit */ .Q(this.el);
  ...
  destroy() {
    makeup_key_emitter__WEBPACK_IMPORTED_MODULE_1__/* .removeKeyDown */ .SM(this.el);
    makeup_exit_emitter__WEBPACK_IMPORTED_MODULE_0__/* .removeFocusExit */ .n(this.el);
...
/* harmony export */ });
/* harmony import */ var makeup_active_descendant__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2022);
/* harmony import */ var makeup_prevent_scroll_keys__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4145);
...
class src_default {
  constructor(widgetEl, selectedOptions) {
    ...
    makeup_prevent_scroll_keys__WEBPACK_IMPORTED_MODULE_1__/* .add */ .W(this.el);
    ...
    this._activeDescendant = makeup_active_descendant__WEBPACK_IMPORTED_MODULE_0__/* .createLinear */ .q(
...
var _makeupListbox = _interopRequireDefault(__webpack_require__(9086));
