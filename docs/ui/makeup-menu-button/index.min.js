...
// EXTERNAL MODULE: ./node_modules/@ebay/skin/menu-button.js
var menu_button = __webpack_require__(9232);
...
;// ./packages/core/makeup-key-emitter/dist/mjs/index.js
...
;// ./packages/core/makeup-navigation-emitter/dist/mjs/index.js
...
class NavigationModel {
  ...
  constructor(el, itemSelector, selectedOptions) {
    this.options = { ...mjs_defaultOptions, ...selectedOptions };
    this._el = el;
...
;// ./packages/core/makeup-roving-tabindex/dist/mjs/index.js
...
class LinearRovingTabindex extends RovingTabindex {
  constructor(el, itemSelector, selectedOptions) {
    super(el);
    this._options = { ...dist_mjs_defaultOptions, ...selectedOptions };
    this._itemSelector = itemSelector;
...
;// ./packages/core/makeup-prevent-scroll-keys/dist/mjs/index.js
...
;// ./packages/ui/makeup-menu/dist/mjs/index.js
...
class makeup_menu_dist_mjs_index_default {
...
;// ./packages/ui/makeup-menu-button/dist/mjs/index.js
...
class makeup_menu_button_dist_mjs_index_default {
  constructor(widgetEl, selectedOptions) {
    ...
    this.menu = new makeup_menu_dist_mjs_index_default(widgetEl.querySelector(this._options.menuSelector), {
      autoReset: "interactive"
    });
    ...
    this._expander = new dist_mjs_index_default(widgetEl, {
...
;// ./docs/ui/makeup-menu-button/index.compiled.js
...
window.onload = function () {
  document.querySelectorAll(".menu-button").forEach(function (el, i) {
    ...
    const widget = new makeup_menu_button_dist_mjs_index_default(el, {
      buttonValueType,
