...
// EXTERNAL MODULE: ./node_modules/@ebay/skin/menu.js
var menu = __webpack_require__(987);
...
;// ./docs/ui/makeup-menu/index.compiled.js
...
window.onload = function () {
  document.querySelectorAll(".menu").forEach(function (el, i) {
    const widget = new mjs_index_default(el);
