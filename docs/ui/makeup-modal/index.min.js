...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   _t: () => (/* binding */ trap),
/* harmony export */   bZ: () => (/* binding */ untrap)
/* harmony export */ });
/* unused harmony export refresh */
/* harmony import */ var makeup_focusables__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5587);
...
function trap(el) {
  ...
  const focusableElements = (0,makeup_focusables__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)(trappedEl, true);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   _: () => (/* binding */ trap),
/* harmony export */   b: () => (/* binding */ untrap)
/* harmony export */ });
/* harmony import */ var _util_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9471);
...
function trap(el, selectedOptions) {
  ...
  const ancestors = _util_js__WEBPACK_IMPORTED_MODULE_0__/* .getAncestors */ .DS(trappedEl);
  let siblings = _util_js__WEBPACK_IMPORTED_MODULE_0__/* .getSiblings */ .A7(trappedEl);
  let siblingsOfAncestors = _util_js__WEBPACK_IMPORTED_MODULE_0__/* .getSiblingsOfAncestors */ .VY(trappedEl);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   A7: () => (/* binding */ getSiblings),
/* harmony export */   DS: () => (/* binding */ getAncestors),
/* harmony export */   VY: () => (/* binding */ getSiblingsOfAncestors)
/* harmony export */ });
...
/* harmony export */   unmodal: () => (/* binding */ unmodal)
/* harmony export */ });
/* harmony import */ var makeup_keyboard_trap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4985);
/* harmony import */ var makeup_screenreader_trap__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1439);
...
function unmodal() {
  if (modalEl) {
    makeup_keyboard_trap__WEBPACK_IMPORTED_MODULE_0__/* .untrap */ .bZ(modalEl);
    makeup_screenreader_trap__WEBPACK_IMPORTED_MODULE_1__/* .untrap */ .b(modalEl);
    unwrap();
    unhoist();
...
function modal(el, options) {
  ...
  makeup_screenreader_trap__WEBPACK_IMPORTED_MODULE_1__/* .trap */ ._(modalEl, options);
  if (!_options.useHiddenProperty) {
    makeup_keyboard_trap__WEBPACK_IMPORTED_MODULE_0__/* .trap */ ._t(modalEl);
  }
...
var modal = _interopRequireWildcard(__webpack_require__(5718));
